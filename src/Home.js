...
function Home() {
  return (
    <div>
      <header>
        <a href="#" class="logo">
          c<span class="fas fa-virus"></span>vid-19
        </a>
        ...
        <div class="box-container">
          <div class="box">
            ...
            <p>
              ...
              Voluptatibus, repudiandae aspernatur eum minus accusamus eligendi
              delectus ad? Similique, facilis esse?
            </p>
          </div>
      ...
      <div class="footer">
        <div class="box-container">
          <div class="box">
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Voluptate minima soluta distinctio eaque magni veritatis dicta
              dolore dignissimos totam quis!
            </p>
          </div>
        ...
        <h1 class="credit">
          created by <a href="#">Nemo Rashed</a> &copy; copyright @ 2022
        </h1>
      </div>
